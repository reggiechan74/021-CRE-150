...
Examples:
  ...
  python eff_rent_calculator.py input_deal.json

  # Save results to specific output file
  python eff_rent_calculator.py input_deal.json -o results.json

  # Use example files
  python eff_rent_calculator.py baf_input_example.json
        """
    )
    ...
    try:
        ...
        print(f"\nUsage: python eff_rent_calculator.py <input_file.json>")
        print(f"\nExample files:")
        print(f"  python eff_rent_calculator.py baf_input_example.json")
        sys.exit(1)
