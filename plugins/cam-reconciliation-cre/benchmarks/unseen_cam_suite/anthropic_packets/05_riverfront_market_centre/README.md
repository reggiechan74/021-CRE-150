# Riverfront Market Centre — Anthropic Packet
...
`plugins/cam-reconciliation-cre/benchmarks/unseen_cam_suite/results/anthropic/05_riverfront_market_centre/anthropic_output.txt`
