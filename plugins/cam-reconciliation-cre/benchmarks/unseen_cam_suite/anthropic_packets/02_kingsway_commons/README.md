# Kingsway Commons — Anthropic Packet
...
`plugins/cam-reconciliation-cre/benchmarks/unseen_cam_suite/results/anthropic/02_kingsway_commons/anthropic_output.txt`
