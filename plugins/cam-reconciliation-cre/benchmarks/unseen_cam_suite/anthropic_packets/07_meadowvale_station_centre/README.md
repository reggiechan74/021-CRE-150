# Meadowvale Station Centre — Anthropic Packet
...
`plugins/cam-reconciliation-cre/benchmarks/unseen_cam_suite/results/anthropic/07_meadowvale_station_centre/anthropic_output.txt`
