# Cedar Ridge Plaza — Anthropic Packet
...
`plugins/cam-reconciliation-cre/benchmarks/unseen_cam_suite/results/anthropic/03_cedar_ridge_plaza/anthropic_output.txt`
